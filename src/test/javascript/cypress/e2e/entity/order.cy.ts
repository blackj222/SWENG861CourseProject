...
describe('Order e2e test', () => {
  ...
  const orderSample = { title: 'energetically', content: 'Li4vZmFrZS1kYXRhL2Jsb2IvaGlwc3Rlci50eHQ=', date: '2024-06-23T17:59:04.059Z' };
  ...
  describe('new Order page', () => {
    ...
    it('should create an instance of Order', () => {
      ...
      cy.get(`[data-cy="date"]`).type('2024-06-23T19:03');
      cy.get(`[data-cy="date"]`).blur();
      cy.get(`[data-cy="date"]`).should('have.value', '2024-06-23T19:03');
